...
import { Movie, MovieItemInfo } from "../types/moviesTypes";

const MovieBlock = styled("div")<{ backgroundimageurl: string }>`
...
export function MoviePage() {
  ...
  const [data, setData] = useState<MovieItemInfo | undefined>();
